...
### 🖥️ Frontend (Modern React)
- ⚛️ React (Hooks, Functional Components)  
- 🔄 Redux Toolkit, React Router & Navigate  
- 🎨 Material-UI (MUI), HTML, CSS, Bootstrap  
...
- ✅ JUnit, Swagger, React Testing Library  
...
|--------|-------------|------|
| [🛒 E-Commerce App](https://github.com/Mehmed6/e-commerce-java-spring-boot) | Full-stack shopping system | Spring Boot, PostgreSQL |
| [👥 Human Resources Flow](https://github.com/Mehmed6/Human-Resources-Flow) | HR automation with JWT & logs | Spring Boot, PostgreSQL |
